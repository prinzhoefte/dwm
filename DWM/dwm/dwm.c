...
drawroundedcorners(Client *c)
{
    ...
    XFillRectangle(dpy, mask, shape_gc, CORNER_RADIUS, 0, width-dia, height);
    XFillRectangle(dpy, mask, shape_gc, 0, CORNER_RADIUS, width, height-dia);
